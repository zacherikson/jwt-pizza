  ...
  return (
    <View title='Sorry to see you go'>
      <div className='text-start py-8 px-4 sm:px-6 lg:px-8'>
        <div className='text-neutral-100'>Are you sure you want to close the {state.franchise.name} store? This cannot be restored. All outstanding revenue with not be refunded.</div>
